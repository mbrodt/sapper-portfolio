...
<a bind:this={postNode} class="card flex block bg-white shadow-lg transition-shadow transition-transform duration-200 hover:shadow-xl transform hover:-translate-y-1 focus:translate-y-0 focus:shadow rounded-lg cursor-pointer group opacity-0 translate-y-16" href="blog/{post.slug}"  style="--transition-order: {index + 2}">
