<script>
  ...
  const deadline = new Date(2020, 10, 28, 0, 0, 0, 0);
...
<div
  ...
  <!-- <svg
    ...
    <g>
      <path
        d="M98.59,51.16c-4.23,0.92-7.88,3.28-9.59,7.35c-1.03,2.47-2.47,8.85-6.42,7.2
        ...
        style="fill:#ED6C30;" />
      <path
        d="M68.13,106.07c2.12,1.78,5.09,0.91,7.09-0.61c1.07-0.81,1.99-1.85,2.59-3.06
        c0.25-0.52,0.54-1.18,0.54-1.77c0-0.79-0.47-1.57-0.27-2.38c1.68-0.33,3.76,4.5,3.97,5.62c1.68,8.83-6.64,16.11-14.67,17.52
        c-13.55,2.37-21.34-9.5-19.78-20.04c0.97-6.56,5.37-11.07,9.85-15.57c3.71-3.73,7.15-6.93,8.35-11.78
        c0.21-0.86,0.16-2.18-0.09-3.03c-0.21-0.73-0.61-1.4-0.63-2.19c-0.06-1.66,1.55,0.51,1.92,0.93c4.46,5.03,5.73,12.46,4.54,18.96
