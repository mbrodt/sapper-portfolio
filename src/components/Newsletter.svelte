...
<div data-aos="fade-up" data-aos-delay="500">
  <div class="mt-8 xl:mt-16 max-w-2xl">
    ...
    <p class="font-body mt-2">
      ...
      development, navigating a tech career, and general life improvement tips.
      My goal is to deliver content that you look forward to receive -
  ...
  {#if state === 'success'}
    <p class="mt-1 sm:mt-2 font-body">
      ...
      - please check your spam folder, and let me know if you haven't received
      it ✌️
    </p>
  {:else}
  ...
  {#if state === 'error'}
    <p class="mt-1 sm:mt-2 font-body">
      Something went wrong - maybe you already signed up with this email? If
